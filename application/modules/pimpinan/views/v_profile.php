    ...
    <div id="main-wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30">
                                    ...
                                    <?php endif;?>
                                    <br>
                                    <h4 class="card-title m-t-10"><?=$akses->nama_lengkap;?></h4>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <!-- Form Upload Foto -->
                                                        <form action="<?=base_url('pimpinan/uploadProfilePicture');?>"
                        ...
                        <div class="card">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="profile" role="tabpanel">
                                    <div class="card-body">
                                        <form class="form-horizontal" action="<?=base_url('pimpinan/update_profile');?>"
                                            method="POST">
                                            <div class="form-group">
                                ...
                                <div class="tab-pane" id="settings" role="tabpanel">
                                    <div class="card-body">
                                        <form action="<?=base_url('pimpinan/update_password');?>" method="POST"
        ...
        $(document).ready(function() {
            ...
            function hapusData(id) {
                $.ajax({
                    url: '<?=base_url()?>pimpinan/hapus_jabatan',
                    type: 'POST',
                    data: {
                        id: id
                    },
