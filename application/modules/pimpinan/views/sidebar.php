            ...
            <ul id="sidebarnav">
                <li class="user-pro">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href=" <?=base_url()?>pimpinan/myprofile"><i class="ti-user"></i> My Profile</a></li>
                    </ul>

                </li>
                <li class="nav-small-cap">--- PERSONAL</li>
                <li> <a class="waves-effect waves-dark" href="<?=base_url()?>pimpinan/pimpinan"><i
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="<?=base_url()?>pimpinan/karyawan">Karyawan</a></li>
                        <li><a href=" <?=base_url()?>pimpinan/jabatan">Jabatan</a></li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
                    ...
                    <ul aria-expanded="false" class="collapse">
						...
						<!-- <li><a href=" <?=base_url()?>pimpinan/laporan"">Laporan</a></li> -->
                    </ul>
                </li>
