...
?>
                                            <tr>
                                                <td>
                                                    ...
                                                    <?php if ($l->status == 6): ?>
                                                    <a target="_blank"
                                                        href="<?=base_url() . 'petugas/cetak_dokumen?d=' . $l->id_ajuan . '&s=' . hash('sha256', $l->created_at)?>"
                                            ...
                                            <div class="modal fade modal-select bs-example-modal-lg"
                                                id="editModal<?=$l->id_ajuan?>" tabindex="-1" role="dialog"
                                                aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="myLargeModalLabel">Edit Data
                                                            </h5>
                                                                    ...
                                                                    <div class="form-group col-md-4">
                                                                        ...
                                                                        <div>
                                                                            <select
                                                                                ...
                                                                                style="width: 100%; height:36px;"
                                                                                name="mengetahui_1">
                                                                                <option value="<?=$l->mengetahui_1?>">
                                                                                    <?=$l->nama_mengetahui1?></option>
                                                                                <option value="">-- Pilih opsi --
                                                                                </option>
                                                                                <?php foreach ($pihak as $p): ?>
                                                                                <option value="<?=$p->id?>">
                                                                    ...
                                                                    <div class="form-group col-md-4">
                                                                        ...
                                                                        <div>
                                                                            <select
                                                                                ...
                                                                                style="width: 100%; height:36px;"
                                                                                name="mengetahui_2">
                                                                                <option value="<?=$l->mengetahui_2?>">
                                                                                    <?=$l->nama_mengetahui2?></option>
                                                                                <option value="">-- Pilih opsi --
                                                                                </option>
                                                                                <?php foreach ($pihak as $p): ?>
                                                                                <option value="<?=$p->id?>">
        ...
        <!-- footer -->
        <!-- ============================================================== -->
        <div class="modal fade modal-select bs-example-modal-lg" tabindex="-1" role="dialog" id="addModal"
                        ...
                        <form class="form-horizontal" action="<?php base_url()?>add_ajuan" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <div>
                                        <select class="select2 form-control custom-select"
                                            style="width: 100%; height:36px;" name="pihak_2" required>
                                            <option value="">-- Pilih opsi --</option>
                                            <?php foreach ($pihak as $p): ?>
                                            <option value="<?=$p->id?>"><?=$p->nama_lengkap?> ( <?=$p->jabatan;?> )
                                            </option>
                                            <?php endforeach;?>
                                        </select>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div>
                                        <select class="select2 form-control custom-select"
                                            style="width: 100%; height:36px;" name="mengetahui_1" required>
                                            <option value="">-- Pilih opsi --</option>
                                            <?php foreach ($pihak as $p): ?>
                                            <option value="<?=$p->id?>"><?=$p->nama_lengkap?> ( <?=$p->jabatan;?> )
                                            </option>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div>
                                        <select class="select2 form-control custom-select"
                                            style="width: 100%; height:36px;" name="mengetahui_2" required>
                                            <option value="">-- Pilih opsi --</option>
                                            <?php foreach ($pihak as $p): ?>
                                            <option value="<?=$p->id?>"><?=$p->nama_lengkap?> ( <?=$p->jabatan;?> )
                                            </option>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Header*</label>
                                    <div>
                                        <textarea id="mymce" name="header">
                                        <h5 class="card-title">
                                        BERITA ACARA REKONSILIASI <br>
                                        REKONSILIASI DATA PERTANGGUNGJAWABAN REALISASI APBD <br>
                                        BADAN PENGELOLA KEUANGAN DAN ASET DAERAH KABUPATEN MEMPAWAH
                                            </h5>
                                        </textarea>
                                    </div>
                                </div>
