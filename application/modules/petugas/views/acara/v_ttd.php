...
<body class="skin-green-dark fixed-layout">
    ...
    ?>
                                            ...
                                            <div class="col-sm-12 text-center">
                                                <a target="_blank"
                                                    href="<?=base_url() . 'petugas/cetak_dokumen?d=' . $list->id_ajuan . '&s=' . hash('sha256', $list->created_at)?>"
                                                        ...
                                                        <form class="form-horizontal">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                    data-dismiss="modal">Tutup</button>
                                                                <button type="button" class="btn btn-primary"
                                                                    onclick="saveSignature('signatureCanvas3', '<?php echo base_url('petugas/simpan_ttd3'); ?>')">Simpan</button>
                                                                <button type="button" class="btn btn-danger"
                                                        ...
                                                        <form class="form-horizontal">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                    data-dismiss="modal">Tutup</button>
                                                                <button type="button" class="btn btn-primary"
                                                                    onclick="saveSignature('signatureCanvas4', '<?php echo base_url('petugas/simpan_ttd4'); ?>')">Simpan</button>
                                                                <button type="button" class="btn btn-danger"
